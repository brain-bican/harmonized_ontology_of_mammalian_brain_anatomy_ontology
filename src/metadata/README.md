 ...
 * [homba.yml](homba.yml)
     * Determines how your purl.obolibrary.org/obo/homba/ redirects will be handled
     ...
     * Paste in the contents of [homba.yml](homba.yml)
 ...
 * [homba.md](homba.md)
     ...
     * Paste in the contents of [homba.md](homba.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
