...
The documentation for HOMBA is managed in two places (relative to the repository root):
...
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://Cellular-Semantics.github.io/harmonized_ontology_of_mammalian_brain_anatomy_ontology/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://Cellular-Semantics.github.io/harmonized_ontology_of_mammalian_brain_anatomy_ontology/). 
